...
/**
 * Created by AA on 2018/1/28.
 */
public class roundedUtils extends ImageView {
    /**
     * 圆形模式
     */
    ...
    public roundedUtils(Context context) {
        super(context);
        initViews();
    }
    public roundedUtils(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }
    public roundedUtils(Context context, AttributeSet attrs, int defStyleAttr) {
